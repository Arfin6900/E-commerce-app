...
const categories=[
       ...
       items:[
        {
            ...
            price:4.00,
            priceId:"price_1OVbqeBsvaxDJwym5nz6uFoW",
            testPriceId:"price_1OVv9EBsvaxDJwymCWQkFw79"
        },
        {
    ...
    },
    {
        ...
        items:[
         {
             name:`Green Zen Balls`,
             description:`Packed with the robust combination of matcha, flax, coconut flakesand almonds these bite-sized wonders are your go-to snack for an instant energy boost.`,
             price:4.00,
             image:item6,
             priceId:"price_1OVgibBsvaxDJwymjincyzHW",
             testPriceId:"price_1OVuzXBsvaxDJwym8Y2lOpBf"
         },
         {
